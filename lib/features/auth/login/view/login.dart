         ...
         return     Column(
                  ...
                  children: [
                    ...
                    CustomButton(
                      ...
                      buttonWidget: state.loginstatus==LoginStatus.loading
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(child: Text('SignIn'), onPressed: () {
                          ...
                          if (state.loginstatus==LoginStatus.errormessage) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text(state.errorMessage??'SignUpfailed')),
                            );
                          }
                          ...
                          if (state.loginstatus==LoginStatus.loaded) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text('Login up successfull')),
                            );
